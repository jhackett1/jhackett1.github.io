$(document).ready(function() {
	...
	function lazyHero() {
		document
			.querySelectorAll("section.hero figure.slideshow div")
			.forEach(function(slide, iterator) {
				...
				if (iterator < 3) {
					...
					setTimeout(function() {
						...
						slide.style.backgroundImage =
							"url(" + slide.getAttribute("data-image-src") + ")";
					}, iterator * 1000);
				}
			});
	}
	...
	function lazyLoadHandler() {
		// Lazy-loading images
		document
			.querySelectorAll("article.category-tile div.image-holder")
			.forEach(function(element) {
				...
				if (
					...
					element.style.backgroundImage =
						"url(" + element.getAttribute("data-image-src") + ")";
